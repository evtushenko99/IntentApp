...
public class Search3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeneratedTextView = findViewById(R.id.search_text_view);
        mRecievedTextView = findViewById(R.id.search_message);
    ...
    private void onClick(@NonNull View view) {
        Intent intent = new Intent(this, PersonalArea4Activity.class);
