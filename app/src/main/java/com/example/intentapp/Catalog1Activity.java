...
public class Catalog1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeneratedTextView = findViewById(R.id.catalog_text_view);
        mRecievedTextView = findViewById(R.id.catalog_message);
        mButton = findViewById(R.id.catalog_button);
